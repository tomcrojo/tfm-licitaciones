...
\includegraphics[width=\textwidth]{figures/tableau-open-opportunities.png}
\caption{Dashboard de demostración construido en Tableau a partir de
\texttt{open\_opportunities.csv}. La vista resume las 14.763 oportunidades
abiertas y permite explorar indicadores y distribuciones por categoría CPV,
territorio, comprador y tramo de presupuesto.}
\end{figure}
...
Ejecución & Batch local reproducible; sin orquestación & Programación con Airflow\\
