...
Engine decision (measured, see ``docs/benchmarks.md`` and
``docs/experiments/silver-engine-comparison-2026-09-16.md``): Polars is the
default canonical Silver engine inside the measured single-node envelope. The
...
an experimental scale-out candidate (:mod:`tfm_licitaciones.silver_spark`) to
be productionized separately if larger deployments justify it.
"""
