    ...
    metrics: dict[str, Any] = {
        ...
        "dataset": {
            ...
            **manifest["inputs"],
            ...
            # Provenance honesty: the e69016f claim only holds when the pin
            # was actually asserted. Unpinned exploratory workloads are
            # generated by whatever generator is current, so their
            # generator commit stays null instead of false provenance.
            "historical_workload_generator_commit": WORKLOAD_GENERATOR_COMMIT,
            "workload_generator_commit": (
                WORKLOAD_GENERATOR_COMMIT if workload["pinned"] else None
            ),
        },
