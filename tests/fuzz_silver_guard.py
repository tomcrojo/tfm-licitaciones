...
VALUES = [
    None, True, False, 0, 1, -1, 125000.5, 1e-5, 1e18, 2**63 - 1, 2**63, 10**100,
...
TED_KEYS = [
    ...
    "url", "PD", "publication_date", "notice-type", "links", "unused",
]
PLACSP_KEYS = [
    ...
    "amount_estimated_overall_currency", "unused",
]
BOE_KEYS = [
...
def run(iterations: int, seed: int) -> list[dict]:
    ...
    for index in range(iterations):
        ...
        if expected[0] != actual[0]:
            divergences.append({
                "seed": seed, "index": index, "kind": "public_status",
